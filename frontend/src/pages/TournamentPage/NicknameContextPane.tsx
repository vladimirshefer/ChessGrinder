...
function NicknameContextPane({ tournamentId }: { tournamentId: string }) {
    ...
    return (
        <div className="grid gap-3 bg-linear-to-br from-primary-400 via-primary-500 to-primary-600 p-5 text-white shadow-xl">
            <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                    ...
                    className="bg-white/10 p-2 text-white transition hover:bg-white/20 focus:outline-hidden focus:ring-1 focus:ring-white/60 focus:ring-offset-primary-500/40"
                >
