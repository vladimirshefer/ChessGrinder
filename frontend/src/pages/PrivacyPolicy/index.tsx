export default function PrivacyPolicyPage() {
    return <div className={"text-left p-3"}>
        <h1 className={"text-lg font-semibold"}>Privacy Policy</h1>
        chessgrinder.com website administration pay great attention to securing the data you provided to us.
        Our privacy policy is based on the General Data Protection Regulation (GDPR) of the European Union.
        The purposes, for which we collect your personal data are:
        improvement of our service, communication with visitors to this site,
        presenting the information requested by the user, providing services associated
        with the website’s specialization, User personal information is required for registration on web-site and getting access to registration on chess tournaments., and for other actions listed below.
        <h2 className={"text-lg font-semibold"}>Personal data storage and processing</h2>
        ...
        name and surname, e-mail address, personal photos. Collection and processing
        of your personal information is carried out in accordance with the laws of
        the European Union and Georgia.
        <h2 className={"text-lg font-semibold"}>Data storage, alteration, and removal</h2>
        The user, who has provided chessgrinder.com with their personal data,
        ...
        data will be stored is: time the personal data is used that is necessary for
        the website’s main activity. After finishing with the processing of your
        ...
        <h2 className={"text-lg font-semibold"}>Processing of visiting technical data</h2>
        Records of your IP address, time of visit, browser settings, operational system and other technical information is saved in the database when you visit chessgrinder.com. This data is necessary for the correct display of the website’s content. It is impossible to identify the person of the visitor using this data.
        Children’s personal information
        If you are a parent or a legal guardian of an underage child, and you know that the child has provided us with their personal information without your consent, please contact us on: quameu+chessgrinder@gmail.com. It is forbidden to enter personal data of underage users without the agreement of parents or lawful guardians.
        <h2 className={"text-lg font-semibold"}>Cookies processing</h2>
        We use cookie files for the correct display of the website’s content and
        for the convenience of browsing chessgrinder.com.
        They are small files that are stored on your device.
        They help the website to remember information about you, such as in
        which language you use the website and which pages have you already opened.
        This information will be useful in the next visit.
        Thanks to cookie files, the website’s browsing becomes much more convenient.
        You can learn more about these files here.
        You can set up cookies reception and blocking in your browser yourself.
