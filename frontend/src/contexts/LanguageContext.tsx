...
export const LanguageContext = React.createContext<Property<string>>(["en", (_l: string) => {
}]);
...
export function LanguageContextProvider({children}: { children: any }) {
    ...
    let navigatorLanguage: string | undefined = window.navigator?.language?.substring(0, 2)?.toLowerCase();
