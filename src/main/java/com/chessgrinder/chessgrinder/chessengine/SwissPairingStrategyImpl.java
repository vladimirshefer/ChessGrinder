...
public class SwissPairingStrategyImpl implements PairingStrategy {
     ...
     * @param roundsNumber Number of allowed rounds
     * @return The list of matches to be played in new round.
     */
    public List<MatchDto> makePairings(List<ParticipantDto> participants, List<List<MatchDto>> matchHistory1, Integer roundsNumber, boolean recalculateResults) {
